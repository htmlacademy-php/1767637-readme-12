...
$post = get_result_query($con, $sql, ['id' => $id]);
$count_like = get_result_query($con, $sql_like, ['id' => $id]);
$count_comment = get_result_query($con, $sql_comment, ['id' => $id]);
$sql_post_comment = get_result_query($con, $sql_post_comment, ['id' => $id]);
